...
var test = require('./test'),
	...
	grammarExpression = [
		...
		'Binary       = ( infix-binary-op /',
		'               SP infixSymbol-binary-op SP)',
		'               Expression--right',
		'Num          = 1*DIGIT-lit',
	...
	grammarSupplyChain = [
		...
		'Binary       = ( *SP infix-binary-operator WSP /',
		'               1*SP infixSymbol-binary-operator CWSP)',
		'               Expression--right',
		'Numeric      = 1*DIGIT',
...
test('lit note leaf', function(t) {
	var product, actual,
		...
		grammarNote = [
			'first  = ACTIONS-FLAG Number-body- FLAG-- note-note raw-customize Number- Note-leaf-0-_Note %x0A',
			'raw    = 1*alpha-lit',
			'Note   = *alpha',
			'note   = 1*ALPHA',
