...
Plugins.OUTDENT = function OUTDENT(n, self) {
	...
	pos = self.eols.length && self.eols[self.eols.length - 1] || 0;
	a.loc.startLine = pos && (self.eols.length + 1) || 1
	a.loc.startCol = 0
	while (self.indent == self.src.charCodeAt(pos + a.loc.startCol))
		a.loc.startCol++;
	a.loc.startCol++;
