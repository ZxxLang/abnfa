...
rule('meta',
  seq(lit('to-'), alt(
    seq(
      lit('bytes'), more('WSP'), alt(
        seq(lit('true'), 'to--true(bytes)'),
        seq(lit('false'), 'to--false(bytes)'),
...
rule('infix', seq(
  lit('('), 'c-wsp',
    lit('node'),     more('WSP'), lit('\''), more('ALPHA--STRING(node)'),    lit('\''), more('c-wsp'),
